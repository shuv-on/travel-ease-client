...
const NavBar = () => {
    ...
    const navLinks = <>
        ...
        {user && (
            <>
                <li>
                    <NavLink to="/addvehicles" className={({ isActive }) => `font-medium hover:text-green-500 ${isActive ? 'text-green-500 font-bold' : ''}`}>Add Vehicle</NavLink>
                </li>
                <li>
                    <NavLink to="/myvehicles" className={({ isActive }) => `font-medium hover:text-green-500 ${isActive ? 'text-green-500 font-bold' : ''}`}>My Vehicles</NavLink>
                </li>
                <li>
                    <NavLink to="/mybookings" className={({ isActive }) => `font-medium hover:text-green-500 ${isActive ? 'text-green-500 font-bold' : ''}`}>My Bookings</NavLink>
                </li>
            </>
        )}
    </>;
